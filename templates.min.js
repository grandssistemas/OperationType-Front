angular.module("operationtype.templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("modules/businessrule/views/base.html","<div id=\"wrapper\"><grands-menu menu-url=\"gumga-menu.json\" keys-url=\"keys.json\"></grands-menu><div id=\"page-wrapper\" class=\"gray-bg\"><grands-nav></grands-nav><page-header tag=\"businessrule.menulabel\"></page-header><div ui-view class=\"wrapper wrapper-content animated fadeInRight\"></div></div></div>");
