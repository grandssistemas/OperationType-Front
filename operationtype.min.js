...
angular.module('app.businessrule', ['ui.router', 'app.businessrule.controllers', 'app.businessrule.services', 'api.location']).config(['$stateProvider', 'apiLocation', function ($stateProvider, apiLocation) {
    $stateProvider.state('businessrule.list', {
        url: '/list',
...
angular.module('app.stock', ['ui.router', 'app.stock.controllers', 'app.stock.services']).config(['$stateProvider', function ($stateProvider) {
    $stateProvider.state('stock.insert', {
        url: '/insert',
...
angular.module('operationtype.core', ['ui.router', 'ngSanitize', 'gumga.core', 'brasil.filters', 'ui.utils.masks', 'datePicker', 'app.stock', 'app.businessrule', 'operationtype.templates', 'paymenttype.core', 'characteristic.core'
//FIMINJECTIONS
...
angular.module('app.businessrule.services').service('BusinessRuleService', ['GumgaRest', 'apiLocation', '$q', '$http', function (GumgaRest, apiLocation, $q, $http) {
...
angular.module('app.stock.services').service('OperationTypeService', ['GumgaRest', 'apiLocation', '$q', function (GumgaRest, apiLocation, $q) {
...
angular.module('app.stock.services').service('StockService', ['GumgaRest', 'apiLocation', '$q', function (GumgaRest, apiLocation, $q) {
...
angular.module('app.businessrule.controllers').controller('BusinessRuleFormController', ['$state', 'entity', '$scope', 'BusinessRuleService', 'PaymentTypeService', 'operationTypes', 'OperationTypeService', function ($state, entity, $scope, BusinessRuleService, PaymentTypeService, operationTypes, OperationTypeService) {
    var identifier = 0;
    ...
    var initializeEntity = function initializeEntity() {
    ...
    $scope.conf = {
        ...
        columnsConfig: [{
            ...
            content: '<div ng-show="$value.value > 0">{{$value.operatorType}}: {{$value.value | currency:\'R$\'}}</div>' + '<div ng-hide="$value.value > 0"><span gumga-translate-tag="label.all">All</span></div>'
        }, {
            name: 'entryValue',
            size: 'col-md-1',
    ...
    $scope.update = function (entity) {
        ...
        BusinessRuleService.saveEntityRule(rules).then(function (brs) {
            var arrOpt = {};
    ...
    $scope.blockBtnAdd = function () {
        if ($scope.clickedBtnBlue) {
            return $scope.entity.operationOwner.length === 0 || !$scope.entity.startDuraction || $scope.entity.parcelsCount === 0 || $scope.entity.entryValue > 0 && $scope.entity.entryPaymentTypes.length === 0 || $scope.entity.entryValue === 0 && $scope.entity.entryPaymentTypes.length > 0 || $scope.entity.parcelsPaymentTypes.length === 0 || $scope.entity.recurrence.value === false && $scope.entity.negotiationInterval === 0;
        } else {
    ...
    $scope.$watch('entity.entryValue', function () {
        if ($scope.entity.entryType === 'PERCENTAGE' && !$scope.entity.id && $scope.clickedBtnBlue && $scope.entity.entryValue > 0.99) {
...
angular.module('app.businessrule.controllers').controller('BusinessRuleListController', ['$scope', 'gumgaController', 'BusinessRuleService', '$rootScope', function ($scope, gumgaController, BusinessRuleService, $rootScope) {
...
angular.module('app.businessrule.controllers').controller('BusinessRuleStepOneController', ['$scope', '$state', 'operations', function ($scope, $state, operations) {
...
angular.module('app.businessrule.controllers').controller('BusinessRuleStepTwoController', ['$scope', '$state', 'operations', 'SweetAlert', 'PaymentTypeService', 'BusinessRuleService', function ($scope, $state, operations, SweetAlert, PaymentTypeService, BusinessRuleService) {
...
angular.module('app.stock.controllers').controller('StockFormController', ['StockService', 'entity', '$scope', 'NotesQueryService', 'OperationTypeService', '$q', function (StockService, entity, $scope, NotesQueryService, OperationTypeService, $q) {
